...
fn run_video_decoder(shared: Arc<SharedPipeline>, mut decoder: H264Decoder) {
...
fn run_audio_decoder(shared: Arc<SharedPipeline>, mut decoder: OpusDecoder) {
...
mod tests {
    ...
    fn paused_and_stopped_sessions_reject_frames() {
        ...
        let session = MediaSession::spawn(Arc::new(OutputBuffers::new()), feedback, commands)
            .expect("session");
