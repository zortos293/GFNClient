...
FocusScope {
    ...
    readonly property var actions: root.page === "guide-session" ? [
        ...
        {label:qsTr("Toggle fullscreen"), action:"fullscreen", value:ShellStore.settings.shortcutToggleFullscreen || "F10"},
        {label:qsTr("Take screenshot"), action:"screenshot", value:ShellStore.settings.shortcutScreenshot || "F11"},
        ...
        {label:qsTr("Guide overlay"), action:"none", value:qsTr("Guide / F1")},
        {label:qsTr("Toggle fullscreen"), action:"fullscreen", value:ShellStore.settings.shortcutToggleFullscreen || "F10"},
        ...
        {label:qsTr("Screenshot"), action:"screenshot", value:ShellStore.settings.shortcutScreenshot || "F11"},
