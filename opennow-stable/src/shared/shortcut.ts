...
function isKeyMatch(event: ShortcutEventLike, shortcutKey: string): boolean {
...
export function isShortcutMatch(event: ShortcutEventLike, shortcut: ParsedShortcut): boolean {
 ...
 */
export function shortcutFromKeyboardEvent(event: ShortcutEventLike): string | null {
